...
<head>
    ...
    <title>Oops!!${msg}</title>
</head>
<body>
<div id="404">
    <a href="<%=request.getContextPath()%>/admin">
        <img style="width: 200px;display: block;margin: 40px auto 0 auto"
             src="<%=request.getContextPath()%>/assets/admin/img/logo.png" alt="">
    </a>
    ...
    <h2 style="font-size: 20px;font-weight: normal;text-align: center;color: #888;">${msg}</h2>
