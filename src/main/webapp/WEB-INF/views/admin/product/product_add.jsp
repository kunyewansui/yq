            ...
            <div class="col-xs-12">
                <form class="form-horizontal" id="createForm" name="createForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-3 ">
                            <input name="shopStock" type="number" class="form-control" value="0" placeholder="件">
                        </div>
                        <div class="col-xs-2 col-md-2 col-lg-2   no-padder text-right">
                            <label class="control-label required">工厂库存：</label>
                        </div>
                        <div class="col-xs-4 col-md-4 col-lg-3 ">
                            <input name="factoryStock" type="number" class="form-control" value="0" placeholder="件">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-2 col-md-2 col-lg-2   no-padder text-right">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-3 ">
                            <input name="cost" type="number" class="form-control" placeholder="￥"/>
                        </div>
                        <div class="col-xs-2 col-md-2 col-lg-2   no-padder text-right">
                            <label class="control-label">出厂价：</label>
                        </div>
                        <div class="col-xs-4 col-md-4 col-lg-3 ">
                            <input name="manuPrice" type="number" class="form-control" placeholder="￥"/>
                        </div>
                    </div>
                    <div class="line line-dashed b-b line-lg"></div>
                    <div class="form-group">
...
<script>
    ...
    var createValidator = $createForm.validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: "<%=request.getContextPath()%>/admin/product/product/save",
                type: "POST",
