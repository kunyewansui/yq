            ...
            <form class="form-horizontal" id="searchForm">
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                        <input class="form-control" type="text" name="dynamic[name]" value="${search.dynamic.name}" placeholder="模糊查询"/>
                    </div>
                    <div class="col-xs-4 col-md-2 col-lg-1 no-padder m-b-md text-right">
                    ...
                    <div class="col-xs-8 col-md-4 col-lg-3 m-b-md">
                        <select id="searchStatus" name="status" class="form-control" data-value="${search.status}">
                            ...
                            <xs:dictOptions key="secStaffStatus"/>
                        </select>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <select id="createStatus" name="status" class="form-control">
                                    <xs:dictOptions key="secStaffStatus" value="1"/>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
