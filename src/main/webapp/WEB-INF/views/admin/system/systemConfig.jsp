    ...
    <script>
        ...
        var createValidator = $createForm.validate({
            ...
            submitHandler: function () {
                ...
                doPost("<%=request.getContextPath()%>/admin/system/systemConfig/save",
...
<script>
    ...
    var updateValidator = $updateForm.validate({
        ...
        submitHandler: function () {
            ...
            doPost("<%=request.getContextPath()%>/admin/system/systemConfig/update",
    ...
    function updateListItem(id) {
        doPost("<%=request.getContextPath()%>/admin/system/systemConfig/get", {id: id}, function (data) {
            if (data.status) {
    ...
    <script>
        function deleteListItem(id) {
            showDeleteModel(null, function () {
                doPost("<%=request.getContextPath()%>/admin/system/systemConfig/remove", {id: id}, function (data) {
                    if (data.status) {
                        setTimeout(function () {
