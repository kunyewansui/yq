...
public class SystemConfigConsts {
    ...
    public static XSStatusPair SYSTEM_CONFIG_EXIST = XSStatusPair.build(10000, "系统配置已存在");

    public static XSStatusPair SYSTEM_CONFIG_NOT_EXIST = XSStatusPair.build(10003, "系统配置不存在");
}
