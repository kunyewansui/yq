...
public class DictConsts {
    ...
    public static XSStatusPair DICT_NOT_EXIST = XSStatusPair.build(10003, "字典不存在");

    public static XSStatusPair DICT_USED = XSStatusPair.build(10001, "字典被使用");

    public static XSStatusPair DICT_LOCKED = XSStatusPair.build(10001, "字典被锁定");
}
